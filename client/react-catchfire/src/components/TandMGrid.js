  ...
  return (
    <div className={page === "tc" ? "VizGrid fadeIn" : "VizGrid fadeOut"}>
      <div className="viz_wide">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to Catchfire Studios LLC, Austin, TX.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to catchfire.finance, accessible from{" "}
              <a href="catchfire.finance" rel="external nofollow noopener" target="_blank">
                catchfire.finance
              </a>
            </p>
          </li>
        ...
        <h1>This site does not contain any investment advice.</h1>
        <h1>Contact Us</h1>
